                            ...
                            <tbody>
                                {#each data.sleeperSeasons as season}
                                    ...
                                    <tr>
                                        ...
                                        <td class="processed">{staging?.processed_count ?? '—'}</td>
                                        <td class="unprocessed">{staging?.unprocessed_count ?? '—'}</td>
                                        <td>
                                            {#if staging}
                                        ...
                                        <td>
                                            <span class="has-data" title="Season exists in leagues table">✓</span>
                                        </td>
                                    </tr>
                                {/each}
                            </tbody>
