 ...
 * Creates a new season with teams
 * 
 * @param {Object} body - Request body
 * @param {number} body.league_id - League ID
 * @param {number} body.season_year - Season year
 * @param {string} body.platform - Platform name
 * @param {string} [body.platform_league_id] - Platform-specific league ID
 * @param {boolean} body.is_active - Whether season is active
 * @param {Array} body.teams - Array of team assignments
 */
 ...
 * Returns all seasons with team counts
 */
