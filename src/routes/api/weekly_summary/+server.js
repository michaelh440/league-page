        ...
        const result = await query(`
            WITH weekly_matchup_details AS (
                SELECT 
                    ...
                    -- Team 1 info
                    m.team1_id,
                    COALESCE(mtn1.team_name, t1.team_name, mgr1.username) as team1_name,
                    ...
                    -- Team 2 info
                    m.team2_id,
                    COALESCE(mtn2.team_name, t2.team_name, mgr2.username) as team2_name,
                    ...
                    -- Winner calculation
                    CASE 
                        WHEN m.team1_score > m.team2_score THEN COALESCE(mtn1.team_name, t1.team_name, mgr1.username)
                        WHEN m.team2_score > m.team1_score THEN COALESCE(mtn2.team_name, t2.team_name, mgr2.username)
                        ELSE 'TIE'
                    END as winner,
                ...
                -- Join through TEAMS table first (team1_id -> teams -> managers)
                ...
                -- Join through TEAMS table first (team2_id -> teams -> managers)
